...
<div class="modal-body">
     <form method="POST" action="{{ route('produk.varian.temp.update', $index) }}" enctype="multipart/form-data">
        @csrf
        <div class="form-group row">
            <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                <input type="text"
                    ...
                    value="{{ $data['namas'] }}" name="namas" required>
                @error('namas')
            ...
            <div class="col-sm-6 mb-3 mb-sm-0">
               <label class="font-weight-bold">Jumlah Stok</label>
                <input type="number"
                    ...
                    value="{{ $data['stok'] }}" name="stok" required>
                @error('stok')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                value="{{ $data['harga'] }}" name="hargab" required>
                @error('hargab')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="col-sm-6">
               <label class="font-weight-bold">Stok Minimal di Gudang</label>
                <input type="number"
                    ...
                    value="{{ $data['stokm'] }}" name="stokm" required>
                @error('stokm')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
